...
LLM_MODEL = "google/gemini-2.5-flash"  # Sử dụng Gemini 2.5 Flash trên OpenRouter
...
def format_context(chunks: list[dict]) -> str:
    ...
    for i, chunk in enumerate(chunks, 1):
        ...
        # Trích xuất tên file cho citation dễ nhìn nếu nó là đường dẫn
...
def generate_with_citation(query: str, top_k: int = TOP_K) -> dict:
    ...
    """
    # Bước 1: Truy vấn tài liệu liên quan
    ...
    # Bước 2: Sắp xếp lại để tránh lost in the middle
    ...
    # Bước 5: Gọi OpenRouter LLM API
    from openai import OpenAI
    api_key = os.getenv("OPENROUTER_API_KEY") or os.getenv("OPENAI_API_KEY")
    if not api_key:
        raise ValueError("OPENROUTER_API_KEY hoặc OPENAI_API_KEY chưa được thiết lập.")
